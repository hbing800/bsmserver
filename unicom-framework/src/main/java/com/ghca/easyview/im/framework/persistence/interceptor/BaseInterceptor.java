package com.ghca.easyview.im.framework.persistence.interceptor;

import com.ghca.easyview.im.framework.common.Global;
import com.ghca.easyview.im.framework.persistence.Page;
import com.ghca.easyview.im.framework.persistence.dialect.Dialect;
import com.ghca.easyview.im.framework.persistence.dialect.db.*;
...
public abstract class BaseInterceptor implements Interceptor, Serializable {
    ...
    /**
     * 对应 BaseEntity Page<T> pageData 属性;
     */
    ...
    protected void initProperties(Properties p) {
        ...
        String dbType = Global.getProperties("jdbc.type");
