...
import com.ghca.easyview.im.framework.annotation.FiledDicAnnotation;
 ...
 */
public class Reflection2Util {
    private static Logger logger = LoggerFactory.getLogger(Reflection2Util.class);
    ...
    public static Object invokeGetterMethod(Object target, String propertyName) {
        ...
        if (propertyName.indexOf(".") != -1) {//如果是以.的对象类型列入user.id

            String[] objs = propertyName.split("\\.");

            if (objs.length == 2) {
                String obj = objs[0];
                String getterObjectName = "get" + StringUtil.capitalize(obj);
                Object object = invokeMethod(target, getterObjectName, new Class[]{}, new Object[]{});//获取对象
                ...
                if (null != object) {
                    ...
                    String methodName = objs[1];
                    String getterMethodName = "get" + StringUtil.capitalize(methodName);
                    result = invokeMethod(object, getterMethodName, new Class[]{}, new Object[]{});//获取对象
                }
            ...
            result = invokeMethod(target, getterMethodName, new Class[]{},
                    new Object[]{});
    ...
    public static Object invokeMethod(final Object object,
        ...
        try {
            ...
            if (method.isAnnotationPresent(FiledDicAnnotation.class)) {

                //如果有这个注解，则获取注解类
                FiledDicAnnotation methodType = (FiledDicAnnotation) method.getAnnotation(FiledDicAnnotation.class);
                if (methodType != null) {

                    String dic = methodType.filedDic();//获取对应字典信息
                    ...
                    try {
                        ...
                        for (String str : dics) {
                            ...
                            String[] keyVaule = str.split(":");
                            if (keyVaule.length == 2) {
                                if (result.toString().trim().equals(keyVaule[0].trim())) {
                                    result = keyVaule[1];
                                    break;
                                }
                            }
